...
class Gerenciador:
    ...
    def roda_loop(self):
        while True:
            ...
            self.bola.movimenta(self.paletas) #jp ao inves de ser vazio tem self.paletas
            ...
            win_score = 5
            if self.placar.p1 == win_score or self.placar.p2 == win_score: #quit placar igual a 5
                time.sleep(5)
                break
